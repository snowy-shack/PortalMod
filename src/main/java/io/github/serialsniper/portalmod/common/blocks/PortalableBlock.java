...
//			System.out.println("2");
			...
			BlockPos otherPos = PortalGun.getPortalPosition(player.getMainHandItem(),
					state.getValue(PortalableBlock.END).other());

			Direction side = world.getBlockState(thisPos).getValue(PortalableBlock.FACING);
			Direction otherSide = world.getBlockState(otherPos).getValue(PortalableBlock.FACING);
