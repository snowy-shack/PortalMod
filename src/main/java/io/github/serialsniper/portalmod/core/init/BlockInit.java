...
//	public static final RegistryObject<StencilBoxBlock> STENCILBOX = BLOCKS.register("stencilbox",
//			() -> new StencilBoxBlock(AbstractBlock.Properties.of(Material.BARRIER).noOcclusion()));
