...
//    public static final Registry<SpawnEggItem> SPAWN_EGGS = new Registry<>();
    ...
    private ItemInit() {}
    private static final Item.Properties GEL_BASE = properties().stacksTo(1);
    ...
    public static final RegistryObject<Item> WRENCH = ITEMS.register("wrench",
            () -> new WrenchItem(properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> ANTLINE = ITEMS.register("antline",
            () -> new AntlineBlockItem(BlockInit.ANTLINE.get(), properties()));
    ...
    public static final RegistryObject<Item> ANTLINE_DECODER = registerBlockItem("antline_decoder", BlockInit.ANTLINE_DECODER);
    public static final RegistryObject<Item> ANTLINE_ENCODER = registerBlockItem("antline_encoder", BlockInit.ANTLINE_ENCODER);
    ...
    public static final RegistryObject<Item> BLACKPLATE = registerPanelBlockItem("blackplate", BlockInit.BLACKPLATE);
    ...
    public static final RegistryObject<Item> ARBORED_LUNECAST = registerPanelBlockItem("arbored_lunecast", BlockInit.ARBORED_LUNECAST);
    ...
    public static final RegistryObject<Item> ARBORED_BLACKPLATE = registerPanelBlockItem("arbored_blackplate", BlockInit.ARBORED_BLACKPLATE);
    ...
    public static final RegistryObject<Item> ERODED_LUNECAST = registerPanelBlockItem("eroded_lunecast", BlockInit.ERODED_LUNECAST);
    ...
    public static final RegistryObject<Item> ERODED_BLACKPLATE = registerPanelBlockItem("eroded_blackplate", BlockInit.ERODED_BLACKPLATE);
    ...
    public static final RegistryObject<Item> FRACTURED_LUNECAST = registerPanelBlockItem("fractured_lunecast", BlockInit.FRACTURED_LUNECAST);
    ...
    public static final RegistryObject<Item> FRACTURED_BLACKPLATE = registerPanelBlockItem("fractured_blackplate", BlockInit.FRACTURED_BLACKPLATE);
    ...
    public static final RegistryObject<Item> VINTAGE_LUNECAST = registerPanelBlockItem("vintage_lunecast", BlockInit.VINTAGE_LUNECAST);
    ...
    public static final RegistryObject<Item> VINTAGE_BLACKPLATE = registerPanelBlockItem("vintage_blackplate", BlockInit.VINTAGE_BLACKPLATE);
...
//    public static final RegistryObject<Item> FIZZLER_FIELD = registerBlockItem("fizzler_field", BlockInit.FIZZLER_FIELD);
    ...
    public static RegistryObject<Item> registerPanelBlockItem(String name, RegistryObject<Block> block) {
        return ItemInit.ITEMS.register(name, () -> new PanelBlockItem(block.get(), properties()));
    }
    ...
    public static RegistryObject<Item> registerSpawnEgg(String name, RegistryObject<? extends EntityType<?>> entity, String tooltip) {
        return ITEMS.register(name, () -> new ModSpawnEggItem(entity,properties().stacksTo(1), tooltip));
    }
    ...
    public static Item.Properties properties() {
        return new Item.Properties().tab(PortalModTab.INSTANCE);
    }
}