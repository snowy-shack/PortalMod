...
public class RecipeInit {
    ...
    public static final RegistryObject<SpecialRecipeSerializer<PortalGunRecipe>> PORTAL_GUN = RECIPES.register("portal_gun_modifying", () -> new SpecialRecipeSerializer<>(PortalGunRecipe::new));
}
