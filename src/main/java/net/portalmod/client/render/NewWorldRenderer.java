...
public class NewWorldRenderer {
    ...
    public static ActiveRenderInfo getCurrentCamera() {
        return currentCamera == null ? Minecraft.getInstance().gameRenderer.getMainCamera() : currentCamera;
    }
...
//        setupRender(p_228426_6_, clippinghelper, flag, Minecraft.getInstance().levelRenderer.frameId++, Minecraft.getInstance().player.isSpectator());
        ...
        PortalRenderer.renderPortals(p_228426_6_, p_228426_2_);
