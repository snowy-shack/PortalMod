...
public class PortalGunCrosshairRenderer {
    ...
    public static void render(MatrixStack matrixStack) {
        ...
        if(!(itemStack.getItem() instanceof PortalGun) || !isFirstPerson || isSpectator)
            return;
        ...
        if(isClassicCrosshair) {
            ...
            primaryFilled = PortalManager.clientHas(gunUUID, PortalEnd.PRIMARY);
            secondaryFilled = PortalManager.clientHas(gunUUID, PortalEnd.SECONDARY);
        }
