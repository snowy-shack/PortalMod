...
public class PortalPhotonParticle extends SpriteTexturedParticle {
    ...
    public static void createOpeningParticles(PortalEntity portal) {
        ...
        for(int i = 0; i < 360; i += 10) {
            for(int j = 0; j < 3; j++) {
                ...
                createRadialParticle(portal, random, startRadius, endRadius, angle,
                        random.nextFloat() + 2,
    ...
    private static void createRadialParticle(PortalEntity portal, Random random, float startRadius, float endRadius, float angle, float speed, float decay) {
        ...
        float x0 = x * startRadius;
        float y0 = y * startRadius * 2;

        float x1 = x * endRadius;
        float y1 = y * endRadius * 2;
        ...
        createParticle(portal.level, random, pos0, pos1, color, speed, decay);
    }

    private static void createParticle(World level, Random random, Vec3 pos0, Vec3 pos1, Color color, float speed, float decay) {
    ...
    public static class PortalPhotonParticleData extends BasicParticleType {
        ...
        public PortalPhotonParticleData(float r, float g, float b, float speed, float decay) {
            super(false);
            this.r = r;
            this.g = g;
            this.b = b;
