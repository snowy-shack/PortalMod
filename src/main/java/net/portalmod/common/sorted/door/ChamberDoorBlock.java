...
public class ChamberDoorBlock extends MultiBlock {
    ...
    public static void playSound(boolean open, BlockState blockState, World world, BlockPos pos) {
        ...
        world.playSound(null, middlePos.x, middlePos.y, middlePos.z, open ? SoundInit.CHAMBER_DOOR_OPEN.get() : SoundInit.CHAMBER_DOOR_CLOSE.get(), SoundCategory.BLOCKS, 2, ModUtil.randomSoundPitch());
    }
